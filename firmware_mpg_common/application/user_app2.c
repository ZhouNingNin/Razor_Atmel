...
void UserApp2Initialize(void)
{
  ...
  LedCommandType aeDemoList[] =
  {
    ...
    {CYAN, 300, TRUE, LED_PWM_0},
    {BLUE, 200, TRUE, LED_PWM_0},
    {PURPLE, 100, TRUE, LED_PWM_0},
    {WHITE, 0, TRUE, LED_PWM_0},
    {LCD_RED,0, TRUE, LED_PWM_0},
    
    {WHITE, 1000, TRUE, LED_PWM_0},
    {PURPLE, 900, TRUE, LED_PWM_0},
    {BLUE, 800, TRUE, LED_PWM_0},
    {CYAN, 700, TRUE, LED_PWM_0},
    {GREEN, 700, TRUE, LED_PWM_0},
    {YELLOW, 800, TRUE, LED_PWM_0},
    {ORANGE, 900, TRUE, LED_PWM_0},
    {RED, 1000, TRUE, LED_PWM_0},   
    {LCD_BLUE,650, TRUE, LED_PWM_0},
    
    {RED, 300, FALSE, LED_PWM_100},
    {ORANGE, 400, FALSE, LED_PWM_100},
    {YELLOW, 500, FALSE, LED_PWM_100},
    {GREEN, 600, FALSE, LED_PWM_100},
    {CYAN, 600, FALSE, LED_PWM_100},
    {BLUE, 500, FALSE, LED_PWM_100},
    {PURPLE, 400, FALSE, LED_PWM_100},
    {WHITE, 300, FALSE, LED_PWM_100},
    {LCD_RED,650, FALSE, LED_PWM_100},

    {WHITE, 1300, FALSE, LED_PWM_100},
    {PURPLE, 1200, FALSE, LED_PWM_100},
    {BLUE, 1100, FALSE, LED_PWM_100},
    {CYAN, 1000, FALSE, LED_PWM_100},
    {GREEN, 1000, FALSE, LED_PWM_100},
    {YELLOW, 1100, FALSE, LED_PWM_100},
    {ORANGE, 1200, FALSE, LED_PWM_100},
    {RED, 1300, TRUE, LED_PWM_0},
    {LCD_BLUE,1300, FALSE, LED_PWM_100},
  };
